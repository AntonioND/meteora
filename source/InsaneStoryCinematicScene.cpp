...
#include "story_insane_png.h"

#include "cinematic_sound_raw.h"



InsaneStoryCinematicScene::InsaneStoryCinematicScene(int i): CScene()  {
    //CScene::CScene();

    number = i;
}

InsaneStoryCinematicScene::~InsaneStoryCinematicScene() {

}

void InsaneStoryCinematicScene::render() {
    ...
    */
    ...
    loadTex(scrapper,story_insane_png);

    gc->addDecoSprite(scrapper);

    ostringstream toptitle;
    toptitle << "insane mode"<< (int)number;
    ...
    loadTex(scrapper,story_insane_png);
     ...
     ostringstream lvldesc;
    lvldesc << "insane level "<< (int)number;
    
    loadTex(scrapper,story_insane_png);
    description = lvldesc.str();
