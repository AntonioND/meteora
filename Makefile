...
SOURCES	:=	gfx source data source/SpellItems date/menu source/ennemyIA
INCLUDES	:=	include build data data/menu
...
#---------------------------------------------------------------------------------
LIBS	:= -lul -lpa9 -lpng -lz -lfat -lnds9 -ldswifi9
 #LIBS	:= -lul -lpa9 -lz -lfat -lnds9
